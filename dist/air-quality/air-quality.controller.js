...
let AirQualityController = class AirQualityController {
    ...
    async getNearestCityAirQuality(lat, lon) {
...
__decorate([
    (0, common_1.Get)('nearest-city'),
    __param(0, (0, common_1.Query)('lat')),
    __param(1, (0, common_1.Query)('lon')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
], AirQualityController.prototype, "getNearestCityAirQuality", null);
__decorate([
    (0, common_1.Get)('paris/most-polluted'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], AirQualityController.prototype, "getParisMostPolluted", null);
